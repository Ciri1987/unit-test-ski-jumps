...
describe('Total Points'.red, () => {

    describe('Hill normal'.rainbow, () => {

        it('should return a number (at positive additional points).'.green, () => {
        ...
        it('should return a number (at negative additional points).'.green, () => {
