...
describe('Style Points'.red, () => {

    it('should return number when notes are the same'.green, () => {
    ...
    it('should return number when two of notes are the same'.green, () => {
    ...
    it('should return number when notes are different'.green, () => {
